...
Number.math_PI = Number(numpy.pi)
Number.math_E = Number(numpy.e)
...
class BuiltInFunction(BaseFunction):
  ...
  def execute_flr(self, exec_ctx):
    ...
    return RTResult().success(Number(numpy.floor(num.to_realnum())))
  ...
  def execute_ceil(self, exec_ctx):
    ...
    return RTResult().success(Number(numpy.ceil(num.to_realnum())))
  ...
  def execute_log(self, exec_ctx):
    ...
    if num.to_realnum() == 0:
      return RTResult().success(Number(- numpy.inf))
    elif numpy.log10(num.to_realnum()) % 1:
      return RTResult().success(Number(round(numpy.log10(num.to_realnum()),2)))
    else:
      return RTResult().success(Number(int(numpy.log10(num.to_realnum()))))
  ...
  def execute_sqrt(self, exec_ctx):
    ...
    square = numpy.sqrt(num.to_realnum())
  ...
  def execute_sin(self, exec_ctx):
    ...
    return RTResult().success(Number(round(numpy.sin(numpy.radians(num.to_realnum())),2)))
  ...
  def execute_cos(self, exec_ctx):
    ...
    return RTResult().success(Number(round(numpy.cos(numpy.radians(num.to_realnum())),2)))
  ...
  def execute_cot(self, exec_ctx):
    ...
    return RTResult().success(Number(round((1/numpy.tan(numpy.radians(num.to_realnum()))),2)))
  ...
  def execute_tan(self, exec_ctx):
    ...
    return RTResult().success(Number(round(numpy.tan(numpy.radians(num.to_realnum())),2)))
  ...
  def execute_asin(self, exec_ctx):
    ...
    return RTResult().success(Number(round(numpy.asin(numpy.radians(num.to_realnum())),2)))
  ...
  def execute_acos(self, exec_ctx):
    ...
    return RTResult().success(Number(round(numpy.acos(numpy.radians(num.to_realnum())),2)))
  ...
  def execute_acot(self, exec_ctx):
    ...
    return RTResult().success(Number(round((numpy.pi/2) - numpy.atan(numpy.radians(num.to_realnum())),2)))
  ...
  def execute_atan(self, exec_ctx):
    ...
    return RTResult().success(Number(round(numpy.atan(numpy.radians(num.to_realnum())),2)))
